...
* Runs automatic hardware tests as one batch, then shows a single auto-summary
  screen
* Groups the manual EPD / button / audio / microphone checks to reduce operator
  actions and EPD refreshes
